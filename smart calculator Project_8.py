...
win.title('Smart Calulator :: PRAVEEN TIWARI')
win.configure(bg='lightskyblue')

l1 = Label(win , text='I am a smart calculator',width=40 , padx=5)
l1.place(x=200,y=20)
l2 = Label(win , text='My name is PRAVEEN' , padx=5)
l2.place(x=250,y=60)
l3 = Label(win , text='What can i help you' , padx=5)
l3.place(x=230,y=160)
